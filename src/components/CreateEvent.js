...
const CreateEvent = (props) => {
    ...
    return (
        <div>
            <form className='mx-10 mb-20 flex flex-col ' onSubmit={props.handleSubmit(onSubmit)}>
                <div className='my-4 flex  items-center'>
                    <h1 className='text-white my-3 font-semibold text-xl uppercase'>Event name</h1>
                    <Field
                ...
                <div className='my-4 flex  items-center'>
                    <h1 className='text-white mr-8 my-3  font-semibold text-xl uppercase'>describe</h1>
                    <Field
                        component={ReduxField}
                        type="text"
                        name="describe"
                ...
                <label for="image_sel" className='bg-cyan-400 mt-10 w-1/2 px-12 py-4  rounded-md text-xl cursor-pointer'>
                    <Field
                        component={FileInput}
                        className="hidden"
                        id="image_sel"
                ...
                <button
                            type="submit"
                            className=' text-white border-4 my-10 py-2 px-12 w-1/2 tracking-widest text-lg font-light bg-cyan-400 border-cyan-400 rounded-2xl uppercase drop-shadow-black'>Add EVENT</button>
            </form>
        </div>
    )
}
