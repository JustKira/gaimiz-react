...
const LoginForm = (props) => {
    ...
    return (
        <div>
          ...
          <div className='col span-1-of-2 user-header-option1'>
              <Link to="/register"><h4>Register</h4></Link>
          </div>
          <div className='col span-1-of-2 user-header-option2'>
            <Link to="/login"><h4>Login</h4></Link>
          </div>
      </div>
      <div className='row white-body'> */}
            <div>
