    ...
    return (
        <form
            ...
            <div
                ...
                <h1 className=' absolute text-white top-14 left-20 text-3xl font-bold'>LAPTOP DESIGN</h1>

                <div
                    className='absolute left-0 top-80 w-full flex justify-between items-center z-10 '>
                    <span className=' cursor-pointer bg-none duration-200 ease-in hover:bg-slate-300 px-3 rounded-full'>
                        <FontAwesomeIcon
                            size="4x"
                            icon="chevron-left"
                            onClick={() => {
                        ...
                        <div className='w-full '>
                            <div className='flex my-32 w-full justify-between items-center'>
                                ...
                                <div className='flex flex-col pr-52 justify-between items-center'>
                                    <h1 className='text-white my-3 font-bold text-2xl uppercase'>BACK</h1>
                                    <div
                                ...
                                <div className='flex flex-col pl-52  justify-between items-center'>
                                    <h1 className='text-white my-3 font-bold text-2xl uppercase'>Keyboard</h1>
                                    <div
                                        className='bg-cyan-400  text-white px-24 py-6 rounded-md flex justify-center items-center relative'>
                                        <label>
                                            <Field
